...
export function TechCard() {
  return (
    <Card>
      ...
      <CardDescription>
        We integrate the most advanced AI technologies to deliver exceptional results for your business automation needs.
      </CardDescription>
...
const Skeleton = () => {
  ...
  return (
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
      ...
      <motion.div
        className="h-40 w-px absolute z-40 bg-gradient-to-b from-transparent via-cyan-500 to-transparent"
