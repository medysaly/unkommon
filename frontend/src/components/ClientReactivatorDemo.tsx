...
const caseStudyData = {
  segmentation: {
    ...
    description: "AI scans your CRM to identify high-value dormant contacts ready for reactivation.",
    messages: [
      { id: 1, sender: "system" as const, text: "Connecting to CRM database...", time: "9:00 AM", type: "action" as const },
      { id: 2, sender: "system" as const, text: "Scanning 2,847 customer records", time: "9:00 AM", type: "action" as const },
      { id: 3, sender: "system" as const, text: "Analyzing: Last visit dates, service history, lifetime value", time: "9:01 AM", type: "action" as const },
      { id: 4, sender: "system" as const, text: "Segment identified: \"Overdue 6+ months\" - 342 contacts", time: "9:01 AM", type: "action" as const },
      { id: 5, sender: "system" as const, text: "Segment identified: \"High-value inactive\" - 127 contacts", time: "9:02 AM", type: "action" as const },
      { id: 6, sender: "system" as const, text: "Segment identified: \"Unsold estimates 2024\" - 89 contacts", time: "9:02 AM", type: "action" as const },
      { id: 7, sender: "system" as const, text: "Priority ranking complete: 558 reactivation candidates", time: "9:03 AM", type: "action" as const },
      { id: 8, sender: "system" as const, text: "Top 50 high-value contacts ready for personalized outreach", time: "9:03 AM", type: "action" as const },
    ],
    workflow: [
    ...
    analysisData: [
      { label: "Total Records Scanned", value: "2,847 contacts", icon: Database },
      { label: "Dormant Contacts Found", value: "558 (19.6%)", icon: Users },
      { label: "High-Value Targets", value: "127 contacts", icon: Zap },
  ...
  outreach: {
    ...
    messages: [
      { id: 1, sender: "system" as const, text: "Initiating personalized outreach to Sarah M. (Last visit: 8 months ago)", time: "10:15 AM", type: "action" as const },
      { id: 2, sender: "business" as const, text: "Hi Sarah! It's been a while since your last visit at Bright Smile Dental. Dr. Martinez wanted me to check in—how have you been?", time: "10:15 AM", type: "message" as const },
      { id: 3, sender: "customer" as const, text: "Oh hi! I've been meaning to schedule a cleaning actually. Just been so busy!", time: "10:23 AM", type: "message" as const },
      { id: 4, sender: "system" as const, text: "Positive response detected - Engaging booking flow", time: "10:23 AM", type: "action" as const },
      { id: 5, sender: "business" as const, text: "Totally understand! Life gets hectic 😊 We have some openings this week if you'd like to get it done. Would mornings or afternoons work better for you?", time: "10:24 AM", type: "message" as const },
      ...
      { id: 7, sender: "business" as const, text: "Perfect! I have Thursday at 2:30 PM or Friday at 3:00 PM available. Which works better?", time: "10:28 AM", type: "message" as const },
    ...
    analysisData: [
      { label: "Contact Type", value: "Dormant 8 months", icon: Users },
  ...
  booking: {
    ...
    messages: [
      ...
      { id: 3, sender: "system" as const, text: "Slot available - Dr. Martinez, Room 3", time: "10:31 AM", type: "action" as const },
      { id: 4, sender: "business" as const, text: "Awesome! I've got you down for Thursday at 2:30 PM with Dr. Martinez. We're at 456 Oak Street. See you then, Sarah!", time: "10:31 AM", type: "message" as const },
      { id: 5, sender: "system" as const, text: "Appointment created in OpenDental - ID: #APT-7823", time: "10:31 AM", type: "action" as const },
    ...
    analysisData: [
      ...
      { label: "Provider Assigned", value: "Dr. Martinez", icon: UserCheck },
      { label: "Calendar System", value: "OpenDental", icon: Database },
